                ...
                <div class="coluna-tres">
                    ...
                    <div class="lista-enderecos">
                        <div class="endereco-um">
                            ...
                            <a href="#">
                                Rua Vicente Linhares, 521, Cj. 2002, Ed. Humberto Santana Business • Aldeota • CEP: 60.135-270
                            </a>
                        </div>
                        <div class="endereco-dois">
                            <strong>Brasília/DF</strong>
                            <a href="#">
                                City Offices, SIG, Quadra 02, Lotes 420, 430 e 44, Sala 13 • CEP: 70610-420
                            </a>
                        </div>
                    </div>

                    <h4 class="title-lgpd">LGPD</h4>
                    <div class="lgpd">
                        <?php
                        wp_nav_menu([
                            'menu' => 'Menu LGPD',
