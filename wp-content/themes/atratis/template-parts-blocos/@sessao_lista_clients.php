...
$lista_de_clientes = get_field('lista_de_clientes', 'option');
...
<section class="sessaoListaClients <?php echo $classe; ?> <?php echo $parallax; ?> " style="<?php echo $geraisCSS; ?>" <?php echo $animacao; ?>>

    <div class="container">
        <div class="row" >
           <div class="grid-arquivo-clients">
                <?php foreach($lista_de_clientes as $item): ?>
