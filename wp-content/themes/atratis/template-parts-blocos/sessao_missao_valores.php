...
<section class="sessaoMissaoValores <?php echo $classe; ?>" style="<?php echo $geraisCSS; ?>" <?php echo $animacao; ?>>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="grid-missao-valores">
                    
                    <?php foreach($lista_cards as $item): ?>
                          <div class="item">
                            <div class="svg-icon"><?php echo $item['svg_icon']; ?></div>
