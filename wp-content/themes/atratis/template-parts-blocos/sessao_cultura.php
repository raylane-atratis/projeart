...
$listaCultura = get_sub_field('lista_cultura');
...
<section class="sessaoCultura <?php echo $classe; ?> <?php echo $parallax; ?> " style="<?php echo $geraisCSS; ?>" <?php echo $animacao; ?>>
        ...
        <div class="row align-items-center">
            <div class="col-lg-12">
                <div class="grid-cultura">
                    <?php foreach($listaCultura as $item){
                        ?>
                            <div class="item-cultura">
