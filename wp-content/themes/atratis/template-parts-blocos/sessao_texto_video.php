...
$video_interno = get_sub_field('video_interno');
$thumbnail_video_interno = get_sub_field('thumbnail_video_interno');
...
<section class="sessaoTextoImagem <?php echo $classe; ?> <?php echo $parallax; ?> " style="<?php echo $geraisCSS; ?>"
    ...
    <div class="container">
        <div class="row align-items-center" style="flex-direction: <?php echo $direction; ?>">
            <div class="col-lg-6">
                <video class="player" data-poster="<?php echo $thumbnail_video_interno['url']; ?>" style="width: 100%;">
                    <source src="<?php echo $video_interno['url']; ?>" type="video/mp4">
                </video>
            </div>
