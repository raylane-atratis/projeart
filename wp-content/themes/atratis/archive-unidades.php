<?php get_header(); ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="grid-arquivo-unidades">
                    <?php if (have_posts()) { 
                        while (have_posts()) { 
                            the_post();

                        $titulo = get_field('titulo_unidade');
                        $descricao = get_field('descricao_unidade');
                        $telefone = get_field('telefone_unidade');
                        $link_telefone = get_field('link_telefone_unidade');
                        $link_mapa = get_field('link_mapa_unidade');
