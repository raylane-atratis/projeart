<aside>
    ...
    <?php
    // Termos da taxonomia 'tipos-de-materiais'
    ...
    if (!is_wp_error($terms) && !empty($terms)):
        $current_term_id = is_tax('tipos-de-materiais') ? get_queried_object_id() : 0;
    ?>
        <div class="navegacao">
            <h3>Navegue por:</h3>
            <ul>
                <?php foreach ($terms as $term):
                    ...
                    $class = $is_current ? 'class="current-category"' : '';
                ?>
                    <li <?php echo $class; ?>>
